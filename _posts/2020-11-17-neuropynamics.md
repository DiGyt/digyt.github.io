...
toolbox for our simulations, one of the largest Python-based toolboxes for simulating spiking neural networks. This 
allows us to do large scale neuron simulations in a matter of seconds.
